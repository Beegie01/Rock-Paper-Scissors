...
def generate_password():
    ...
    SEP1,SEP2,SEP3 = "*12345", "0123456789", "$67890"
    LEFT,RIGHT = 'aAbBcCdDeEfF', 'zZlLhHpPmMkK'
    return f"{random.choice(SEP1)}{random.choice(LEFT)}{random.choice(LEFT)}{random.choice(SEP2)}{random.choice(RIGHT)}{random.choice(RIGHT)}{random.choice(SEP3)}"
